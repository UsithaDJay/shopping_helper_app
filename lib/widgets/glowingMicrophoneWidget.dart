...
class GlowingMicrophoneIcon extends StatefulWidget {
  @override
  _GlowingMicrophoneIconState createState() => _GlowingMicrophoneIconState();
}

class _GlowingMicrophoneIconState extends State<GlowingMicrophoneIcon> {
    ...
    return Center(
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: Colors.red.withOpacity(0.3), // Adjust opacity and color
          boxShadow: isGlowing
              ? [
                  BoxShadow(
